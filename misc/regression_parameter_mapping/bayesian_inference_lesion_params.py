"""Map regression beta parameters for Lesion Deficit Inference for Lesions.
...
if SAMPLE_MODE == SampleSelectionMode.STROKE:
    output_dir = BETA_PARAMETER_MAP_OUTDIR / f"{OUTPUT_DIR_BASE}_{timestamp}"
elif SAMPLE_MODE == SampleSelectionMode.STROKE_TRAUMA:
    output_dir = (
        BETA_PARAMETER_MAP_OUTDIR
        / AETIOLOGY_SENSITIVITY_ANALYSIS_SUBDIR
...
filename = output_dir / f"Betas_full_lesion_{timestamp}.nii.gz"
