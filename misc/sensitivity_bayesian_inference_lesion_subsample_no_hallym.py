"""Perform Bayesian Lesion Deficit Inference for Lesions while excluding the Hallym Subsample.
...
OUTPUT_DIR_BASE = "Output_Lesion_SensNoHallym"
HALLYM = "Hallym"
...
params = {
    ...
    "Sensitivity Analysis": "Exclusion of Korea Hallym Data",
    "timestamp": timestamp,
