"""Perform Bayesian Lesion Deficit Inference for Disconn. Maps while excluding the Korean Sample.
...
OUTPUT_DIR_BASE = "Output_SDSM_SensNoKorea"
BUNDANG = "Bundang"
HALLYM = "Hallym"
...
SDSM_ANALYSIS_MASK_PATH = (
    Path(__file__).parents[1] / "misc" / "sdsm_analysis_mask.nii.gz"
)
