...
This analysis employs additional control for the variables sex and age.
...
data[SEX_NUMERIC] = data[Cols.SEX].map(
    {
        "Male": 0,
        "Female": 1,
    }
...
# define covariates
covariates_arr = data[[Cols.AGE, SEX_NUMERIC]].to_numpy()
